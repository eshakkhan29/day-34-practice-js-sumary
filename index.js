...
// #module_release #basic_javascript_milestone #module_22_5 
...
var myName = 'eshak khan'
var amiWebDeveloperHobo = true;
var takaAche = 556;
...
let myAge = 23;
myAge = 24;
const myFatherName = 'ibrahim Khan'
...
const man2 = 25;
if (man1 < man2) {
    console.log('প্রথমটা সেকেন্ডটা এর চাইতে ছোট');
}
else if (man1 > man2) {
    console.log("প্রথমটা সেকেন্ডটা এর চাইতে বড়");
}
else if (man1 == man2) {
    console.log("প্রথমটা সেকেন্ডটা সমান");
}
else if (man1 != man2) {
    console.log("প্রথমটা সেকেন্ডটা সমান না");
}
else if (man1 <= man2) {
    console.log("প্রথমটা সেকেন্ডটা এর চাইতে ছোট অথবা সমান");
}
else if (man1 >= man2) {
    console.log("প্রথমটা সেকেন্ডটা এর চাইতে বড়  অথবা সমান");
}
...
const secendMan = 32;
const thardMan = 21;
if (firstMan == secendMan && firstMan < thardMan) {
    console.log("দুইটা শর্ত পূরন হলে আমাকে দেখাবে");
}
else if (firstMan == secendMan || firstMan < thardMan) {
    console.log("যে কোন একটা শর্ত পূরন হলে আমাকে দেখাবে");
}
...
const fbAche = true;
const twitterAche = false;
if (fbAche == twitterAche) {
    console.log("fb and twitter ache");
}
else {
    console.log("ze kono ekta ache");
}
...
const ageList = [12, 34, 45, 75, 37, 23, 22, 10, 22, 30, 36];
...
const findMax = [20, 24, 54, 76, 98, 83, 23, 90];
let maxThen80 = 0;
for (let i = 0; i < findMax.length; i++) {
    const element = findMax[i];
    if (element > 80) {
        maxThen80 = element;
        console.log(maxThen80);
    }
}
...
const gunShongkha = [5, 6, 8];
const inputFuntion = gunFol2(gunShongkha);
console.log(inputFuntion);

// ১২. একটা অবজেক্ট ডিক্লেয়ার করবে। সেটাতে তিনটা প্রপার্টি থাকবে। এবং কোন একটা প্রোপার্টি এর মান চেইঞ্জ করবা। 

let myMobile = {name: 'realme', price: 22500, model: '5 pro'};
console.log(myMobile);
myMobile.price = 18600;
console.log(myMobile);
...
function paperRequirements(book1, book2, book3) {
    ...
    const book3Page = 300;
    // mot page 
    const firstBook = book1Page * book1;
    const secendBook = book2Page * book2;
    const thardBook = book3Page * book3;
    let totalPage = firstBook + secendBook + thardBook;
    return totalPage;
}
const book1 = 8;
const book2 = 5;
const book3 = 3;
const pages = paperRequirements(book1, book2, book3);
console.log(pages);

// ৪. একটা ফাংশন লিখবে। এই ফাংশনের নাম হবে bestFriend তারপর সেই ফাংশনে ইনপুট প্যারামিটার হিসেবে একটা array নিবে। সেই array এর মধ্যে তোমার সব ফ্রেন্ডের নাম থাকবে। এখন তোমার কাজ হচ্ছে যে ফ্রেন্ড এর নাম সবচেয়ে বড় সেই ফ্রেন্ড এর নাম রিটার্ন করে দেয়া। এই ক্ষেত্রে তুমি নামটা অর্থাৎ ফ্রেন্ডের নাম (স্ট্রিং) রিটার্ন করতে হবে। 

const frienList = ['eshak khan', 'md. naim khan', 'zubayer', 'mahmus hasan', 'masud', 'far had'];
...
function bestFriend(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        if (element.length > boroNam.length) {
            boroNam = element;
        }
    }
    return boroNam;
}
const borotaDekhao = bestFriend(frienList);
console.log(borotaDekhao);

// ৫. এইটা একটু ট্রিকি হতে পারে। একটা array এর মধ্যে অনেকগুলা সংখ্যা থাকবে। তোমার কাজ হচ্ছে সংখ্যা গুলা একটার পর একটা করে চেক করা। এবং সংখ্যা গুলা যদি পজিটিভ সংখ্যা হয়। অর্থাৎ শূন্য বা শূন্যের চাইতে বড় হয় তাহলে সেগুলাকে কোন একটা array এর মধ্যে রাখবে। আর যদি নেগেটিভ সংখ্যা হয়। তাহলে লুপটা স্টপ করে দিবে। এবং লুপ বন্ধ করার আগ পর্যন্ত যতগুলা পজিটিভ সংখ্যা পাওয়া গেছে। সেগুলা রিটার্ন করে দিবে। 

const numberList = [6, 4, 8, 2, 3, -5, -7, 56, 34, 9];
function chakeNumbers(numbers) {
    let prosetiveNumbers = [];
    for (let i = 0; i < numbers.length; i++) {
        const element = numbers[i];
        if (element >= 0) {
            prosetiveNumbers.push(element);
        }
        else {
            break
        }
    }
    return prosetiveNumbers;
}
const number = chakeNumbers(numberList);
console.log(number);
